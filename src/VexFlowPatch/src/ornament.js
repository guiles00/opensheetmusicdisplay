...
export class Ornament extends Modifier {
  ...
  draw() {
    ...
    const svgParent = ctx.parent;
    const firstOrnamentNodeIndex = svgParent ? svgParent.childNodes.length : 0;
    ...
    if (svgParent) {
      for (let i = firstOrnamentNodeIndex; i < svgParent.childNodes.length; i++) {
        svgParent.childNodes[i].classList?.add('vf-ornament');
      }
    }
  }
}
